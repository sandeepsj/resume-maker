...
import { getProfile, saveProfile } from "@/lib/google-drive";
...
export function ProfileForm({ initialProfile, userName, userEmail }: ProfileFormProps) {
    ...
    <div className="bg-white border border-slate-200 rounded-xl p-6 space-y-5">
      <div className="grid grid-cols-2 gap-5">
        <div>
          ...
          <p className="text-xs text-slate-400 mt-1">Managed by your Google account.</p>
        </div>
        <div>
      ...
      {success && <div className="p-3 bg-green-50 border border-green-200 rounded-lg text-sm text-green-700">Profile saved successfully.</div>}
