...
export default async function PrintResumePage({
  ...
  if (!resume || !resume.content) notFound();
  ...
  return (
    <>
      ...
      {/* A4 page: 210mm × 297mm. At 96dpi that is 794px × 1123px. */}
      <div
        id="resume-print"
        className="w-[794px] min-h-[1123px] mx-auto bg-white px-[60px] py-[48px] print:w-full print:min-h-0 print:px-0 print:py-0 print:mx-0"
      >
        {/* Header */}
        <div className="mb-5 pb-4 border-b border-slate-300">
          ...
          {header.headline && (
            <p className="text-[13px] text-slate-600 mt-1">{header.headline}</p>
          )}
        ...
        {summary && (
          <div className="mb-4">
            <h2 className="text-[10px] font-bold text-slate-900 uppercase tracking-widest mb-1.5">
              Summary
            </h2>
        ...
        {experience.length > 0 && (
          <div className="mb-4">
            <h2 className="text-[10px] font-bold text-slate-900 uppercase tracking-widest mb-2">
              Experience
            </h2>
              ...
              {experience.map((exp, i) => (
                <div key={exp.id ?? i}>
                  <div className="flex items-start justify-between">
                    ...
                    <p className="text-[10.5px] text-slate-500 shrink-0 ml-3">
            ...
            <div className="space-y-1">
              {skills.map((group, i) => (
                <div key={i} className="flex gap-2 text-[11px]">
                  <span className="font-semibold text-slate-700 shrink-0 w-[130px]">
                    {group.category}:
                  </span>
